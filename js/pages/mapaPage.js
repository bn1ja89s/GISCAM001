import { escapeHtml, formatDecimalInput, toNullableNumber } from "../core/helpers.js";
...
function formatMeters(value) {
  ...
  return number == null ? "-" : `${formatDecimalInput(number.toFixed(2))} m`;
}

function formatCoordinate(value) {
  const number = toNullableNumber(value);
  return number == null ? "-" : formatDecimalInput(number.toFixed(6));
}
