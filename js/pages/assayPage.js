...
export function renderAssayPage({ activeProject, activeProjectCollars, activeProjectAssays, editingAssay, captureFlow, selectedAssayCollarUuid }) {
  return `
    <section class="page-grid page-grid--2">
      <article class="card">
        ...
        <div class="card__body">
          ${renderAssayForm({ activeProject, activeProjectCollars, activeProjectAssays, editingAssay, captureFlow, selectedAssayCollarUuid })}
        </div>
      </article>
