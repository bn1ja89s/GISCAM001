import { escapeHtml, formatDecimalInput, todayValue } from "../core/helpers.js";
...
function optionDataAttrs(match) {
  ...
  return [
    ...
    ["data-contraccion", formatDecimalInput(match.contraccion)],
    ["data-absorcion", formatDecimalInput(match.absorcion)],
...
export function renderLaboratorioForm({ activeProject, activeProjectAssays, activeProjectLaboratorios = [], editingLaboratorio }) {
  ...
  return `
    <form id="laboratorio-form" class="stack" autocomplete="off">
      ...
      <div class="grid-fields">
        <label class="field"><span>Contraccion</span><input class="input" name="contraccion" type="text" inputmode="decimal" value="${escapeHtml(formatDecimalInput(contraccionValue))}"></label>
        <label class="field"><span>Absorcion</span><input class="input" name="absorcion" type="text" inputmode="decimal" value="${escapeHtml(formatDecimalInput(absorcionValue))}"></label>
      </div>
      <label class="field">
