            ...
            <article class="list-item stack">
              <div class="section-head">
                <div>
                  ...
                  <p class="muted">Prof: ${escapeHtml(formatDecimalInput(survey.profundidad) || "-")}</p>
                </div>
                ${renderSyncBadge(survey.estado_sync)}
              </div>
              <div class="list-item__meta">
                <span>DIP: ${escapeHtml(formatDecimalInput(survey.dip) || "-")}</span>
                <span>Azimut: ${escapeHtml(formatDecimalInput(survey.azimut) || "-")}</span>
