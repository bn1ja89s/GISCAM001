          ...
          (collar) => `
            <article class="list-item stack">
              ...
              <div class="list-item__meta">
                ...
                <span>Este: ${escapeHtml(formatDecimalInput(collar.este) || "-")}</span>
                <span>Norte: ${escapeHtml(formatDecimalInput(collar.norte) || "-")}</span>
                <span>Prof: ${escapeHtml(formatDecimalInput(collar.prof_total || 0))} m</span>
              </div>
